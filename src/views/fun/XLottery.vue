          ...
          <CardView v-if="filteredUsers.length > 0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div class="flex items-end">
                <button
                  @click="drawLottery"
                  class="w-full px-6 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-lg transition-all transform hover:scale-105"
                >
                  🎉 开始抽奖
                </button>
              </div>
            ...
            <div v-if="winners.length > 0" class="border-t border-gray-200 dark:border-zinc-700 pt-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                <div
                  ...
                  :key="index"
                  class="flex items-center space-x-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border-2 border-amber-300 dark:border-amber-700"
                >
                  <div class="shrink-0 w-10 h-10 bg-amber-500 rounded-full flex items-center justify-center text-white font-bold">
                    {{ index + 1 }}
                  </div>
